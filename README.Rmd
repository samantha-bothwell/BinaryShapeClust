...
It looks like the correct subjects were sorted into the correct clusters. To verify, we can use external vailidation to assess if the true cluster assignment matches the assigned one under dynamic time warping. 
...
If we do not know the true cluster assingment, we can use internal validation indices instead.  
